...
9. Create missing labels in GitHub if required, then stage, commit, push, open PR, apply metadata, publish tracked QA evidence, and post the QA summary comment when verification ran.
